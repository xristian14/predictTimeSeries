...
data_sources_meta = [
    features.DataSourceMeta(files=[
        ...
        ], date_index = 0, data_indexes = [1,2,3,4,5,11], is_save_data=True,
        normalizers=[
    ...
    features.DataSourceMeta(files=[
        ...
        ], date_index = 0, data_indexes = [1,2,3,4,6], is_save_data=True,
        normalizers=[
