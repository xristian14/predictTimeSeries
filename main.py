...
data_sources_meta = [
    features.DataSourceMeta(files=[
        ...
        normalizers=[
            normalizers.DynamicAbsoluteMinMaxScaler(data_indexes=[1,2,3,4], output_weight=1, over_rate_low=over_rate, over_rate_high=over_rate, add_values=[2416], is_auto_over_rate_low=True, auto_over_rate_low_multipy=1.5, auto_over_rate_low_min=0.1, is_auto_over_rate_high=True, auto_over_rate_high_multipy=1.5, auto_over_rate_high_min=0.1),
            normalizers.DynamicAbsoluteMinMaxScaler(data_indexes=[5], output_weight=1, over_rate_low=0.05, over_rate_high=over_rate, add_values=[0], is_auto_over_rate_high=True, auto_over_rate_high_multipy=1.5, auto_over_rate_high_min=0.1)
    ...
    features.DataSourceMeta(files=[
        ...
        normalizers=[
            normalizers.DynamicAbsoluteMinMaxScaler(data_indexes=[1, 2, 3, 4], output_weight=1, over_rate_low=over_rate, over_rate_high=over_rate, add_values=[154], is_auto_over_rate_low=True, auto_over_rate_low_multipy=1.5, auto_over_rate_low_min=0.1, is_auto_over_rate_high=True, auto_over_rate_high_multipy=1.5, auto_over_rate_high_min=0.1),
            normalizers.DynamicAbsoluteMinMaxScaler(data_indexes=[5], output_weight=1, over_rate_low=0.05, over_rate_high=over_rate, add_values=[0], is_auto_over_rate_high=True, auto_over_rate_high_multipy=1.5, auto_over_rate_high_min=0.1)
        ], visualize=[("candle", [1,2,3,4]), ("line", [5])], is_visualize=True, visualize_ratio=[3,1], visualize_name=["price", "volume"])
